...
class FacebookGroupify extends core.Construct {
  constructor(scope, id) {
    ...
    // const image = ecs.ContainerImage.fromAsset('../scraper');
    // // const vpc = new ec2.Vpc(stack, 'MyVpc', { maxAzs: 2 });
    const cluster = new ecs.Cluster(this, 'Cluster', { });
    // Create the scheduled task

    const fargateScheduledTask = new ecsPatterns.ScheduledFargateTask(this, 'ScheduledFargateTask', {
      cluster,
      scheduledFargateTaskImageOptions: {
        ...
        cpu: 256,
        environment: {
          GROUP_ID: '288793014548229',
          PLAYLIST_ID: '4KKkRiBsA6mFxHEvU9DXeL',
          RUN_LENGTH: '10',
    ...
    bucket.grantReadWrite(fargateScheduledTask.taskDefinition.taskRole);
    ssmParams.grantRead(fargateScheduledTask.taskDefinition.taskRole);
    ssmParams.grantWrite(fargateScheduledTask.taskDefinition.taskRole);
  }
}
